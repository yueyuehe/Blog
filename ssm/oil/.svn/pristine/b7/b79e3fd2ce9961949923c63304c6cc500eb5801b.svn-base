 ...
 * 
 */
public interface BasePipelinePatrolDAO_2016 {
	...
	public void updatePipelinePatro(PipelinePatrol_2016 pipelinePatrol);
	
	public void deletePipelinePatrolDetailById(@Param(value="pp_id") Integer pp_id);
	
	public void insertPipelinePatrol(PipelinePatrol_2016 pipelinePatrol);
	
	public void insertPipelinePatrolDetail(PipelinePatrolDetail pipelinePatrolDetail);
	
	public PipelinePatrol_2016 queryLastPatrolByUserId(@Param(value="id") Integer id, @Param(value="pl_id") Integer pl_id);;
	
	public List<PipelinePatrol_2016> queryPatrols(Map<String, Object> param);
	
	public PipelinePatrol_2016 queryPatrolById(@Param(value="id") Integer id);

...
public class SimpleMailSender {
	...
	/**   
	  ...
	  */    
	    public static boolean sendMail(List<String> address,String title,String content) {    
	    	MailSenderInfo mailInfo = new MailSenderInfo();
	 		mailInfo.setMailServerHost("smtp.ym.163.com");
	 		mailInfo.setMailServerPort("25");
	 		mailInfo.setValidate(true);
	 		mailInfo.setUserName("eric@llzey.com");
	 		mailInfo.setPassword("long1994192297");// 您的邮箱密码
	 		mailInfo.setFromAddress("eric@llzey.com");
	 		
	 		
	 		mailInfo.setToAddress(address);
	 		mailInfo.setSubject(title);
	 		//String base = SettingUtils.getCommonSetting("base.url");

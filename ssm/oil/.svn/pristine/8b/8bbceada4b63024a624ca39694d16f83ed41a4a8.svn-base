...
public class PageSupport {
	...
	public void setIsInit(boolean b)
	{
		isInit = b;
	}
	...
	public int getCurrentPage() {
		if (totalRecord % pageSize == 0) {
			return (totalRecord-pageOffset) / pageSize;
		} else {
			return (totalRecord-pageOffset) / pageSize + 1;
		}		
	}
	...
	public int getNextPageOffset() {
		return (getTotalPage()-1-getCurrentPage()) * pageSize;
	}
	...
	public boolean hasPreviousPage() {
		return getPrevPageOffset() <= getFirstPageOffset();
	}
	...
	public boolean isFirst() {
		return getFirstPageOffset() == getPageOffset();
	}
	...
	public Integer getShowLastPageNo() {
		...
		return lastPN;*/
		return getTotalPage() > 1 ? getTotalPage() : 1;
	}
	...
	public static PageSupport initPageSupport(HttpServletRequest request) {
		...
		pageSupport.setIsInit(offset!=null);

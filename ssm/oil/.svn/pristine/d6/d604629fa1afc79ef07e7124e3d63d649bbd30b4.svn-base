...
public class PerformanceMeasure {
	...
	private List<PerformanceMeasureDetail> detailList;
	...
	public List<PerformanceMeasureDetail> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<PerformanceMeasureDetail> detailList) {

...
public interface BasePerformanceMeasureDao_2016 {
	
	public PerformanceMeasure_2016 queryLastPMeasureByUserId(@Param(value="id")Integer id, @Param(value="pl_id")Integer pl_id);
	...
	public List<PerformanceMeasure_2016> queryPMeasures(Map<String, Object> param);
	
	public void updatePerformanceMeasure(PerformanceMeasure_2016 performanceMeasure);
	
	public void deletePerformanceMeasureDetailByPMid(@Param(value="pm_id") Integer pm_id);
	
	public void insertPerformanceMeasure(PerformanceMeasure_2016 pm);
